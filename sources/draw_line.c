...
int	get_color_for_step(int step, int steps, int color1, int color2)
{
	...
	color_steps[0] = (float)ft_abs_int(get_a(color1) - get_a(color2)) / (float)steps;
	color_steps[1] = (float)ft_abs_int(get_r(color1) - get_r(color2)) / (float)steps;
	color_steps[2] = (float)ft_abs_int(get_g(color1) - get_g(color2)) / (float)steps;
	color_steps[3] = (float)ft_abs_int(get_b(color1) - get_b(color2)) / (float)steps;
