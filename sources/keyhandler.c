...
int	handle_keypress(int keycode, t_fdf *fdf)
{
	if (keycode == K_ESC)
		destroy(fdf);
	if  (keycode == K_RIGHT)
		add_angle_to_rotation_matrix(fdf->screen_info->rotation_matrix, -fdf->screen_info->rotation_speed, axis_y, 0);
	else if (keycode == K_LEFT)
		add_angle_to_rotation_matrix(fdf->screen_info->rotation_matrix, fdf->screen_info->rotation_speed, axis_y, 0);
	else if (keycode == K_UP)
		add_angle_to_rotation_matrix(fdf->screen_info->rotation_matrix, -fdf->screen_info->rotation_speed, axis_x, 0);
	else if (keycode == K_DOWN)
		add_angle_to_rotation_matrix(fdf->screen_info->rotation_matrix, fdf->screen_info->rotation_speed, axis_x, 0);
	else if (keycode == K_A)
		add_angle_to_rotation_matrix(fdf->screen_info->rotation_matrix, -fdf->screen_info->rotation_speed, axis_z, 0);
	else if (keycode == K_D)
		add_angle_to_rotation_matrix(fdf->screen_info->rotation_matrix, fdf->screen_info->rotation_speed, axis_z, 0);
